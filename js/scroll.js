$(function () {
  ...
  if (horizontalScrollerItems.length) {
    gsap.to(horizontalScrollerItems, {
      ...
      scrollTrigger: {
        ...
        pin: true,
        scrub: 1,
        end: () => "+=" + document.querySelector(".horizontalScroller__item").offsetWidth,
      }
    });
  }
  ...
  createScrollTrigger(mainEndLineText, -10, ".MainEndLineText", "top bottom", "bottom top");
  createScrollTrigger(lineUp, 5, ".LineUp", "top bottom", "bottom top");
  createScrollTrigger(lineBot, -5, ".LineBot", "top bottom", "bottom top");
  createScrollTrigger(aboutLineUp, -5, ".AboutLineUp", "top bottom", "bottom top");
  createScrollTrigger(aboutLineBot, 5, ".AboutLineBot", "top bottom", "top -100%");
  ...
  // Apply width scroll triggers for contact lines
  createWidthScrollTrigger(document.querySelector('.LineUpContact'), '80%', ".LineUpContact", "top bottom", "bottom top");
  createWidthScrollTrigger(document.querySelector('.LineBotContact'), '100%', ".LineBotContact", "top bottom", "bottom top");
